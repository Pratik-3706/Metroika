            ...
            <div class="section-header">
                <div>
                    ...
                    <div class="text-sm text-muted mt-1">
                        ...
                        ${extracted['detected_category'] ? ` · <span style="color:var(--accent); font-weight:600;">Type: ${extracted['detected_category'].toUpperCase()}</span>` : ''}
                    </div>
                </div>
                <div class="flex gap-3" style="align-items: center; flex-wrap: wrap;">
                    ...
                    <select id="manual-category" class="form-control" style="width: auto; display: inline-block;">
        ...
        return `
            <div class="card mb-6">
                ...
                <div style="display: flex; flex-wrap: wrap; gap: 6px; margin-bottom: 10px; font-size: 0.68rem;">
                    ...
                    <span style="padding: 2px 6px; border-radius: 3px; background: rgba(45,106,79,0.08); color: #2d6a4f; border: 1px solid rgba(45,106,79,0.2);">■ Manufacturer</span>
                    ...
                    <span style="padding: 2px 6px; border-radius: 3px; background: rgba(0,128,128,0.08); color: #008080; border: 1px solid rgba(0,128,128,0.2);">■ Nutritional</span>
                    <span style="padding: 2px 6px; border-radius: 3px; background: rgba(180,60,100,0.08); color: #b43c64; border: 1px solid rgba(180,60,100,0.2);">■ Ingredients</span>
