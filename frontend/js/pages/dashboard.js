...
const DashboardPage = {
    ...
    _renderSkeletonStats() {
        return Array(4).fill('').map(() => `
            <div class="stat-card">
                <div class="stat-label" style="background: var(--border); height: 12px; width: 70px; border-radius: 3px;"></div>
                <div class="stat-value" style="background: var(--border); height: 28px; width: 50px; border-radius: 4px; margin-top: 8px;"></div>
            </div>
        `).join('');
    },
